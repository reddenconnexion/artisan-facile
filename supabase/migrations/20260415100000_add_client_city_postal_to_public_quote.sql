-- Ajouter postal_code et city du client dans la RPC get_public_quote
-- Ces champs existent dans la table clients (migration 20260401100000)
-- mais étaient manquants dans le jsonb_build_object → ville absente sur le PDF public
