    ...
    return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="relative flex">
                ...
                />
                {/* Raccourci pour lancer la navigation GPS vers le rendez-vous */}
                {nextEvent?.address && (
                    <a
...
const Dashboard = () => {
    ...
    const widgetRenderers = {
        ...
        recent_documents: () => {
            ...
            const STATUS_LABEL = { draft: 'Brouillon', sent: 'Envoyé', accepted: 'Signé', billed: 'Facturé', paid: 'Payé', cancelled: 'Annulée' };
            const STATUS_COLOR = {
