...
const BRANDS = {
  ...
  // Legrand DNX³/Drivia : 25mm mesuré au pied à coulisse par l'utilisateur
  // sur son tableau réel (après deux estimations visuelles trop courtes :
  // 12mm puis 18mm).
  legrand:    { label: "Legrand DRIVIA / RX³", modulePitch: 17.5, height: 25, rowSize: 13 },
