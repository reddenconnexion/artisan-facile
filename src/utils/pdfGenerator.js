...
const PDF_I18N = {
    fr: {
        ...
        legalInsurance: (company, contractNumber, companyAddress, coverageArea) => `Assurance décennale et responsabilité civile professionnelle : contrat${contractNumber ? ` n° ${contractNumber}` : ''} souscrit auprès de ${company}${companyAddress ? `, ${companyAddress}` : ''}${coverageArea ? ` — Couverture géographique : ${coverageArea}` : ''}.`,
    ...
    en: {
        ...
        legalInsurance: (company, contractNumber, companyAddress, coverageArea) => `Ten-year building warranty and professional liability insurance: policy${contractNumber ? ` no. ${contractNumber}` : ''} underwritten by ${company}${companyAddress ? `, ${companyAddress}` : ''}${coverageArea ? ` — Geographical coverage: ${coverageArea}` : ''}.`,
